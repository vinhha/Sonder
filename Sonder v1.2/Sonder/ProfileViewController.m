...
- (void)viewDidLoad
{
    ...
    self.contentView.frame = CGRectMake(-180, -235, 320, 568);
    self.refreshButton.frame = CGRectMake(20, 300, 280, 30);
    ...
    //self.bioButton.frame = CGRectMake(0, 300, 307, 216);
    ...
    [self.contentView addSubview:self.complimentLabel];
