...
- (void)viewDidLoad
{
    ...
    self.contentView.frame = CGRectMake(-160, -245, 320, 568);
    ...
    [testButton setTitle:@"COMPLIMENT" forState:UIControlStateNormal];
    ...
    testButton.frame = CGRectMake(30, 300, 260, 30);
    ...
    twitterButton.frame = CGRectMake(140, 435, 45, 45);
    ...
    facebookButton.frame = CGRectMake(45, 435, 45, 45);
    [facebookButton addTarget:self action:@selector(facebookProfile:) forControlEvents:UIControlEventTouchUpInside];
    ...
    instaButton.frame = CGRectMake(235, 435, 45, 45);
    ...
    photoButton.frame = CGRectMake(30, 70, 120, 120);
