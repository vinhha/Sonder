	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContinueTextView.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
				...
				if (school.isEmpty() || hometown.isEmpty()){
					...
					@SuppressLint("InlinedApi") public void done(ParseException e) {
					    if (e == null) {
					      // Hooray! Let them use the app now.
					    	 Toast.makeText(SignUpProfileActivity.this,
					 		        "Success!", Toast.LENGTH_SHORT).show();
					    	Intent intent = new Intent(SignUpProfileActivity.this, SignUpAboutActivity.class);
