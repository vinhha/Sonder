...
public class ComposeActivityThoughts extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionBar.setCustomView(R.layout.back_left_action_bar_thoughts_compose);
		...
		mContinueButton.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
				...
				if (post.isEmpty()){
					AlertDialog.Builder builder = new AlertDialog.Builder(ComposeActivityThoughts.this);
						...
						@SuppressLint("InlinedApi") public void done(ParseException e) {
						    if (e == null) {
						      // Hooray! Let them use the app now.
						    	 Toast.makeText(ComposeActivityThoughts.this,
						 		        "Success!", Toast.LENGTH_SHORT).show();
						    	Intent intent = new Intent(ComposeActivityThoughts.this, PostActivity.class);
	...
	public void Back (View v) {
		Intent intent = new Intent(ComposeActivityThoughts.this, ThoughtsActivity.class);
		intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
		intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
		startActivity(intent);
	}
