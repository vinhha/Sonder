...
public class SignUpAboutActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContinueButton.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
				...
				if (bio.isEmpty()){
					AlertDialog.Builder builder = new AlertDialog.Builder(SignUpAboutActivity.this);
						...
						@SuppressLint("InlinedApi") public void done(ParseException e) {
						    if (e == null) {
						      // Hooray! Let them use the app now.
						    	 Toast.makeText(SignUpAboutActivity.this,
						 		        "Success!", Toast.LENGTH_SHORT).show();
						    	Intent intent = new Intent(SignUpAboutActivity.this, SignUpSocialMediaActivity.class);
